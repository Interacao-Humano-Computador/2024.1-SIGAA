...
- **Observação:** Todos os entrevistados são estudantes, pois as funcionalidades trabalhadas são direcionadas a estudantes.
...
| ------------------ | ------------------ | ----------------- | -------- | -------- | -------- | -------- | -------- |-------- |
| Larissa Stéfane | Carlos Gabriel | Aluguel de Sala | O participante gostou de como a funcionalidade foi apresentada e organizada. | Carlos acredita que a funcionalidade está intuitiva, uma vez que as informações e os títulos das tarefas transmitem bem a ideia do que cada função ou etapa faz e espera do usuário. | <li> Mostrar as opções de salas com sua capacidade. <br> <li> Ter um fluxo principal que evita que o usuário se perca no caminho, ou seja, é fácil seguir só um caminho sem se perder ou confundir. <br> <li> Ter a opção ou a liberdade de voltar para a etapa anterior ou para a página principal. | <li>   se o usuários forem iniciantes ou leigos em relação ao SIGAA, seria difícil encontrar a funcionalidade, que está na “aba outros”.| Baixa. O participante afirmou que conseguiu completar cada etapa sem complicações.  | O usuário não cometeu denhum erro durante o procedimento. |
...
| Breno Alexandre | Victor Moreira Almeida | Aba do RU | Sim, o participante afirmou que sim. | Redundâncias em alguns passos.. | O participante não mencionou elementos que geraram desmotivação. | O participante acredita que sim. | Redundâncias em alguns passos e formas de pagamentos não muito práticas. | <li> Ao invés de aparecer um botão quando clicar em "RU" na tela inicial do SIGAA, ja ir direto para a página sobre o RU. <li> Não precisar esconder nem colapsar as opções de campus do cardápio. <li> Tirar as opções de pagamento além do PIX, por ser mais prático e plausível de ser usado. <li> Tirar a função de suporte ao usuário dentro da recarga de crédito, pois é considerado trivial. |
...
| 1.6 | Adição das informações para a funcionalidade de Solicitação de Bolsas| Iago Passaglia| Luana Medeiros | 19/06/2024 |
| 1.7 | Adição das informações para a funcionalidade da Aba de RU | Breno Alexandre | Luana Medeiros | 19/06/2024 |
| 1.8 | Adição da Conclusão | Pedro Izarias | Luana Medeiros | 19/06/2024 |
