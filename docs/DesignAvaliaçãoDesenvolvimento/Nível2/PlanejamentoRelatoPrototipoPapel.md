...
- Apresentação das observações e respostas dos usuários.
...
- A tabela 5 deve mostrar como o participante interagiu com o protótipo e como ele se sentiu.
...
- A tabela 6 mostrará as observações sobre a usabilidade da funcionalidade.
...
- A tabela 7 mostrará as observações sobre os problemas e as soluções
