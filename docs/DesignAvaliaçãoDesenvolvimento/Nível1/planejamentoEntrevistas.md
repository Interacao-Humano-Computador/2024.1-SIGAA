...
1. **Conferir se tem todos os matériais necessários(60 a 30 minutos antes da reunião):** Garantir que está em posse de todos instrumentos e ferramentas.

2. **Preparar o local (15 minutos antes da reunião):** Garantir que o ambiente tenha mesa e cadeiras disponíveis e esteja silencioso.
...
#### Perguntas sobre a análise de tarefas
...
<details>
  <summary size="20"><b>  Questionário Avaliação de acordo com os objetivos </b></summary> 

**Observação:** Nesta etapa do projeto o foco é a opinião do usuário em relação às tarefas e não a interfcace, por isso as perguntas escolhidas são voltadas para isso.
...
| - | - | - | - | - |
| 1.0 | Criação e realização do documento | Larissa Stéfane | - | 22/05/2024 |
