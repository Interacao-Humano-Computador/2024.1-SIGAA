...
| Breno Alexandre | Limírio Correia| <li> Estudante de Engenharia de Software. <br> <li>  É do gênero masculino e tem 22 anos. <br> <li>  Utiliza computadores e dispositivos móveis diariamente. <br> <li>  Seu nível de habilidade com tecnologia é alto. <br> <li>  Sua familiaridade com uso de sistemas acadêmicos é alta. | Aba do RU |
...
| Declaração de Bolsas | Sim.| Foram coerentes na visão dele. | Nada além do que foi dito anteriormente. |
