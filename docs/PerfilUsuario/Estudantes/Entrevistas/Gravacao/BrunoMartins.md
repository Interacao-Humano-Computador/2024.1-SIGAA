...
Clique em: [Termo de consentimento assinado](docs/Midia/Termos_Consentimentos_AssinadosTermo_/Bruno.pdf) 
...
A entrevista realizada com o Bruno proporcionou uma perspectiva valiosa sobre o seu relacionamento com o Sistema Integrado de Gestão de Atividades Acadêmicas (SIGAA), o que permiriu identificar pontos que precisam ser melhorados no site.
