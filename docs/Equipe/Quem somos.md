## :earth_americas: Quem somos:
  ...
  <div align="center">
  <img src="Midia/EquipeIHC.png">
  
   Figura 1: Logo da equipe criado [Aqui](https://www.designevo.com/).
</div>

Somos uma equipe que faz parte da disciplina de Interação Humano Computador, no semestre 2024.1,  ministrada pelo professor André de Sales Barros na Universidade de Brasília (UnB). 

Com entusiasmo e dedicação, o nosso grupo planeja realizar um projeto que se debruça sobre a análise do site SIGAA com os discentes da UnB.
