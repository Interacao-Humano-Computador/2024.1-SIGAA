# Verificação e Inspeção do Planejamento de Avaliação da Análise de Tarefas
...
## Introdução
O seguinte documento possui o intuito de criar uma lista de verificação para o artefato do Planejamento de Avaliação da Análise de Tarefas criado pelo grupo 03 do aplicativo dos correios da disciplina de IHC, semestre 2024.1. O documento apresenta uma tabela com perguntas a serem feitas sobre a criação do Planejamento de Avaliação da Análise de Tarefas, a fim de garantir que o mesmo siga diretrizes e mantenha o padrão definido pela literatura da disciplina, visando a melhoria do artefato.
...
A tabela 1 mostra a lista de veriicação realizada para se fazer a inspeção em relação ao Planejamento de Avaliação da Análise de Tarefas.

<center>

Tabela 1: Lista de Verificação do Planejamento de Avaliação da Análise de Tarefas
