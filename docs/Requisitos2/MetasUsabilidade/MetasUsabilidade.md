...
Geralmente, o SIGAA oferece uma curva de aprendizado suave devido à sua interface intuitiva, feedback visual imediato e suporte técnico disponível, evitando que o usuário precise de um longo período de treinamento. Em resumo, o SIGAA tende a oferecer uma boa experiência de aprendizado aos usuários.
...
Geralmente, o SIGAA oferece uma experiência de memorização relativamente boa devido à sua consistência visual, feedback de utilização e navegação intuitiva. Porém é um sistema com muitas funcionalidades e complexo, é essencial que os usuários pratiquem o uso regular do SIGAA para reforçar a memorização e manter uma fluência na sua utilização.
...
| ------ | ------------------------------------------------------------------------------------ | --------------- | -------------- | ---------- |
| 1.0    | Criação do documento                                                                 | Luana Medeiros  | -              | 12/05/2024 |
