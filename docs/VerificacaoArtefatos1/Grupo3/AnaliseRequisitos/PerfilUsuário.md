...
| 18  | Indica quais são os idioma que os usuários falam?                                            | Deve listar quais idiomas o usuário conhece e utiliza fluentemente  |  Interação Humano-Computador e Experiência do Usuário”, de Barbosa e Silva, Capítulo 7, tópico 2, "Que Dados Coletar?", página 138.                                               | https://github.com/Interacao-Humano-Computador/2024.1-SIGAA/blob/main/docs/Midia/PerfiLUsuario_CapturasTela/Screenshot%20from%202024-06-12%2020-49-40.png |
